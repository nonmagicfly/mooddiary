...
## О чем проект
`MoodDiary` — это дневник эмоций, в котором пользователь ежедневно фиксирует настроение, энергию, продуктивность, уровень стресса, качество сна, заметки, теги/симптомы и (опционально) фотографии. Данные используются для просмотра динамики и базовой аналитики.
